...
class TestBotAgent(unittest.TestCase):
    ...
    def test_get_bot_success(self, mock_get_bot, mock_create_token, mock_create_breadcrumb):
    ...
    @patch("stage0_py_utils.agents.bot_agent.create_echo_token")  
    @patch("stage0_py_utils.services.bot_services.BotServices.get_bot")
    def test_get_bot_fail(self, mock_get_bot, mock_create_token, mock_create_breadcrumb):
    ...
    def test_get_channels_success(self, mock_get_channels, mock_create_token, mock_create_breadcrumb):
        """Test successful execution of get_bot action."""
    ...
    @patch("stage0_py_utils.agents.bot_agent.create_echo_token")  
    @patch("stage0_py_utils.services.bot_services.BotServices.get_channels")
    def test_get_channels_fail(self, mock_get_channels, mock_create_token, mock_create_breadcrumb):
        """Test failure case for get_bot action."""
